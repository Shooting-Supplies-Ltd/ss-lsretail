...
export async function getAmmo() {
  ...
  &Category.categoryID=IN,[23,46,82,218,71,62,116,197,35,241,233,268,269,287,282]&ItemECommerce.listOnStore=true&orderby=description`);
  return ammo;
}
...
export async function getAccessories() {
  ...
  &Category.categoryID=IN,[28,95,119,177,102,286,288,31,265,284,186,16,114,11,260,26,289,126,77,153,73,2,262,163,21,78,261,24,263,76,166,212,56,59,42,103,104,236,66,285,145,207,134,231,88,141]&ItemECommerce.listOnStore=true&orderby=description`);
  return accessories;
}
