...
export async function getItems() {
  const items = makeRequest(
    `Item.json?load_relations=["Category", "Manufacturer", "Images", "ItemShops", "ItemECommerce", "CustomFieldValues"]&CustomFieldValues.customFieldID=7&orderby=description`
  );
  return items;
}
...
export async function getItem(itemID) {
  const item = makeRequest(
    `Item/${itemID}.json?load_relations=["Category", "Manufacturer", "Images", "ItemShops", "ItemPrices", "ItemECommerce", "Manufacturer", "CustomFieldValues"]`
  );
  return item;
}
...
export async function getItemsByCategory(categoryID) {
  const itemsByCategory =
    makeRequest(`Item.json?load_relations=["Category", "Manufacturer", "Images", "ItemShops", "ItemECommerce", "CustomFieldValues"]
...
export async function getMatrixClothing() {
  const matrixClothing =
    makeRequest(`ItemMatrix.json?load_relations=["Category", "Manufacturer", "Images", "ItemECommerce"]
...
export async function getMatrixClothingItem(itemID) {
  const matrixClothingItem = makeRequest(
    `ItemMatrix/${itemID}.json?load_relations=["Category", "Manufacturer", "Images", "ItemECommerce"]&CustomFieldValues.customFieldID=7`
  );
