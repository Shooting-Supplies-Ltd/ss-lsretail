...
const TippmannProductCard = ({ item }) => {
    ...
    <div className="block h-80 border-2 border-gray-300 rounded-lg" key={item.itemID}>
      <Link href={`${router.pathname}/${item.itemID ? item.itemID : item.itemMatrixID}/${slug}`}>
        <a>
          ...
          <div className="h-32 p-4 flex flex-col bg-black text-white hover:text-red-600 rounded-b-lg">
...
export default TippmannProductCard;
