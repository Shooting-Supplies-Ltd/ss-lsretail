...
export async function getAccessories() {
  ...
  const accessories = await accessoriesData.data.Item
  return accessories
}
...
export async function getOptics() {
  ...
  const optics = await opticsData.data.Item
  return optics
}
...
export async function getSecurity() {
  ...
  const security = await securityData.data.Item
  return security
}
...
export async function getMaintenance() {
  ...
  const maintenance = await maintenanceData.data.Item
  return maintenance
}
