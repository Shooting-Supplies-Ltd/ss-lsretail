...
const Blog = ({ posts }) => (
  <>
    <Head>
      ...
      <meta
        name="description"
        content="News & Updates from Shooting Supplies"
      />
      ...
      <meta
        property="og:url"
        content="https://shootingsuppliesltd.co.uk/blog"
      />
      <meta name="twitter:card" content="summary_large_image" />
      <meta charSet="UTF-8" />
    </Head>
    <main className="my-28 mx-12">
      <ul className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 xl:grid-cols-4 xl:grid-cols-4 gap-4">
        {posts &&
          posts.map((post) => (
            <li key={post._id}>
              <PostCard item={post} key={post._id} />
            </li>
          ))}
      </ul>
    </main>
